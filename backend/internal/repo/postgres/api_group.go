...
func (r *APIGroupRepo) Create(ctx context.Context, g *domain.APIGroup) error {
...
func (r *APIGroupRepo) Update(ctx context.Context, g *domain.APIGroup) error {
...
func (r *APIGroupRepo) Delete(ctx context.Context, tenantID, id int64) error {
	_, err := r.DB.Pool.Exec(ctx, `DELETE FROM api_groups WHERE tenant_id=$1 AND id=$2`, tenantID, id)
	return err
}

func (r *APIGroupRepo) List(ctx context.Context, tenantID, projectID int64, p domain.ListParams) ([]*domain.APIGroup, int, error) {
...
func (r *APIGroupRepo) GetByID(ctx context.Context, tenantID, id int64) (*domain.APIGroup, error) {
	var g domain.APIGroup
...
func (r *APIGroupRepo) GetByName(ctx context.Context, tenantID, projectID int64, name string) (*domain.APIGroup, error) {
	var g domain.APIGroup
	err := r.DB.Pool.QueryRow(ctx,
