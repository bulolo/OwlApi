        ...
        {projects.map((project) => (
          ...
          >
            <Link href={`/${activeTenant}/projects/${project.id}/apis`}>
              <Card className="bg-white border-zinc-100 rounded-lg shadow-sm hover:shadow-sm hover:border-blue-600/30 transition-all duration-300 cursor-pointer h-full flex flex-col pt-1">
