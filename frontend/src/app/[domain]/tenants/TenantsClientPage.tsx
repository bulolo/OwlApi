  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <StatsCard title="在线 Runner 节点" value="48" subValue="2 节点异常" icon={Shield} />
      </div>
              ...
              <div className="flex items-center justify-between">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3 mt-1 text-[11px] text-zinc-400 font-medium">
                      <span className="flex items-center gap-1">
                        <Globe className="w-3 h-3" /> {tenant.domain}.owlapi.pro
                      </span>
                      <span className="w-1 h-1 rounded-full bg-zinc-200" />
                      <span className="flex items-center gap-1">
                        <Clock className="w-3 h-3" /> 开通于 {tenant.createdAt}
                      </span>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-12 text-center">
                  <div className="hidden md:block">
                    ...
                    <p className="text-xs font-bold text-zinc-700">{tenant.plan}</p>
                  </div>
                  <div className="hidden md:block">
                    <p className="text-[10px] font-black text-zinc-400 uppercase tracking-widest mb-0.5">成员/API</p>
                    <p className="text-xs font-bold text-zinc-700">{tenant.users} / {tenant.apis}</p>
                  </div>
