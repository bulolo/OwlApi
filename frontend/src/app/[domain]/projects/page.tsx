...
import { Plus, FolderGit2, ChevronRight, Clock, Settings, Activity, AlertCircle, Zap } from "lucide-react"
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-zinc-900 tracking-tight">所有项目</h1>
