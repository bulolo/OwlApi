          ...
          {activeTab === "runner" && (
            <div className="space-y-6">
              <SettingsCard title="网关节点集群参数" icon={Cpu} iconColor="text-zinc-600">
                <div className="grid grid-cols-2 gap-6">
                  <FormItem label="心跳间隔 (秒)" description="节点向控制面上报状态的频率">                    <Input type="number" defaultValue="10" className="h-9 text-xs" />
                  </FormItem>
                  <FormItem label="日志保留天数" description="网关节点本地日志的存储期限">
              ...
              <SettingsCard title="自动更新与同步">
                <div className="space-y-4">
                  <ToggleItem 
                    title="自动热更新" 
                    description="检测到新版本规则时，网关节点无需重启即可应用" 
                    defaultChecked 
                  />
                  <ToggleItem 
                    title="二进制自动升级" 
                    description="有新的版本发布时，自动在非业务时段更新网关节点镜像" 
                  />
                </div>
              </SettingsCard>
            </div>
              ...
              <SettingsCard title="告警通知 Webhook" icon={Bell} iconColor="text-orange-500">
                <div className="space-y-6">
                  <div className="space-y-4">
                    <ToggleItem 
                      title="启用 Webhook 告警" 
                      description="当网关节点离线或 SQL 查询超时时发送 POST 请求" 
                      defaultChecked 
                    />
                  ...
                  <div className="pt-2 border-t border-zinc-50 border-dashed">
                    ...
                    <div className="grid grid-cols-2 gap-x-12 gap-y-3">
                      <ToggleItem title="节点状态变更" description="网关节点上线/离线提醒" defaultChecked />
