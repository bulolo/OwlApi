...
func (a *TenantRepo) List(ctx context.Context) ([]*domain.Tenant, error) {
	return a.R.ListTenants(ctx)
}
...
func (a *MemberRepo) GetByTenantID(ctx context.Context, tenantID string) ([]*domain.TenantMember, error) {
	return a.R.GetMembersByTenantID(ctx, tenantID)
}
