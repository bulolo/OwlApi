    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1 font-medium">通过自建执行节点实现跨网络数据库安全接入</p>
        </div>
              ...
              <Card className="bg-white border-zinc-200/60 rounded-xl shadow-sm hover:shadow-xl hover:border-blue-500/30 transition-all duration-300 flex flex-col h-full overflow-hidden">
                <div className="p-6">
                  <div className="flex items-start justify-between mb-4">
                    <div className={cn("w-12 h-12 rounded-xl flex items-center justify-center border shadow-sm transition-colors", DB_TYPE_COLORS[ds.type as keyof typeof DB_TYPE_COLORS])}>
                  ...
                  <div className="mt-6 space-y-3">
                    <div className="flex flex-col gap-1.5">
                       <span className="text-[9px] font-bold text-zinc-400 uppercase tracking-widest">Environment Enpoints</span>
