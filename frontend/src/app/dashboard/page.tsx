...
import { Plus, FolderGit2, ChevronRight, Clock } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-4 gap-4">
        {projects.map((project, i) => (
          ...
          >
            <Link href={`/dashboard/projects/${project.id}/apis`}>
              <Card className="bg-white border-zinc-200 hover:border-blue-400 hover:shadow-md transition-all duration-300 group cursor-pointer h-full flex flex-col pt-1">
                <CardHeader className="px-4 pt-4 pb-3">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-[10px] font-bold py-0.5 px-2 bg-zinc-100 text-zinc-500 rounded uppercase tracking-tighter">Project</span>
                  </div>
        ...
        {/* Dense Add Project */}
        <div className="border-2 border-dashed border-zinc-200 rounded-lg flex flex-col items-center justify-center p-6 bg-white hover:bg-zinc-50 hover:border-blue-300 transition-all cursor-pointer group h-full min-h-[160px]">
