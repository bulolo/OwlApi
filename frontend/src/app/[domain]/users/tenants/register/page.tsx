          ...
          <Card className="p-8 border-zinc-200/60 shadow-lg shadow-zinc-200/20">
            {step === 1 && (
              ...
              >
                ...
                <div className="space-y-2">
                  <Label className="text-xs font-black uppercase text-zinc-400">专属访问二级域名</Label>
                  <div className="flex items-center gap-2">
                    <Input 
                      placeholder="aliyun" 
                      value={formData.domain}
                      onChange={(e) => setFormData({...formData, domain: e.target.value})}
                      className="h-11 font-mono text-right"
                    />
                    <span className="text-sm font-bold text-zinc-400">.owlapi.pro</span>
                  </div>
                </div>
              ...
              >
                ...
                <div className="p-4 bg-zinc-50 rounded-xl border border-dashed border-zinc-200 text-left">
                   <div className="flex items-center justify-between text-xs mb-2">
                      ...
                      <span className="font-mono font-bold text-blue-600">{formData.domain}.owlapi.pro</span>
                   </div>
